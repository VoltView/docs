...
<CardGroup cols={2}>
  <Card title="Solar" icon="sun" href="/api-reference/assets/solar">
    Generation, self-consumption, and export, mapped to the site and its import MPAN.
  </Card>
  <Card title="Batteries" icon="battery-full" href="/api-reference/assets/batteries">
...
We add OEM portals one at a time, starting with the platforms on live pilots. There is no claim of "every inverter." If a site uses a portal we do not support yet, we say so and take a file export or a later connector. See [Solar](/api-reference/assets/solar) for the current list.
