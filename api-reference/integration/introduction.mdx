...
1. Add utility accounts with the [Create an Account](/api-reference/integration/create-account) endpoint
2. Connect to your utility provider's website using your saved credentials
3. Access your utility data through the API endpoints
