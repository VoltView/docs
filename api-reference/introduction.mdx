...
kWh is what the site consumed. kvarh and kVAh appear on electricity invoices and in bill-validation consumption objects when the meter or the supplier provides them. Capacity is contracted in kVA; measured peak demand is returned in kW. See [Energy and power](/metering/energy-and-power) and [Demand and capacity](/metering/demand).
